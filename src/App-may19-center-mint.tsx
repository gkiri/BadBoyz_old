  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <div className="flex flex-col items-center py-4 mb-10">{/* Add margin-bottom (mb-10) here */}
        <h2 className="text-2xl font-bold mb-2">BadBoyz Mint</h2>
      ...
      <div className="flex items-center justify-center w-full max-w-xl">
        <div className="flex items-center justify-center w-full h-full col-span-1 lg:col-span-7">
          <div className="contract-metadata flex flex-col gap-4 p-6 lg:border rounded-xl lg:border-gray-800">
            ...
            <div className="flex w-full gap-4">
              {dropNotReady ? (
                ...
                <div className="mint-box flex items-center justify-center w-full h-full col-span-1 lg:col-span-7">
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    {address ? (
                      <Web3Button
                        className="mint-button" // Add this line
                        contractAddress={
